...
public class SelectUsersTests
{
    private readonly UsersFilter _filterUsers = new();

    [Fact]
    public void SelectUsers_ShouldReturnEmpty_WhereNullInput()
    {
        // Arrange
    ...
    [Fact]
    public void SelectUsers_ShouldReturnEmpty_WhereEmptyInput()
    {
        // Arrange
    ...
    [Fact]
    public void SelectUsers_ShouldReturnEmpty_WhereNoMatchesInput()
    {
        // Arrange
    ...
    [Fact]
    public void SelectUsers_ShouldReturnSortedUsers_WhereCorrectInput()
    {
        // Arrange
